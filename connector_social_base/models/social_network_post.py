...
class SocialNetworkPost(models.Model):
    ...
    def _render_template_preview(self):
        ...
        for account in self.account_ids:
            ...
            try:
                render_template += """\n\n""" + IrQweb._render(
                    "connector_social_{}.social_network_post_preview".format(
                ...
                render_template += """\n\n""" + IrQweb._render(
                    "connector_social_base.social_network_post_preview",
                    values | self._render_values_preview(),
                )
    ...
    def _compute_post_preview(self):
        ...
        Template ID format:
         * connector_social_{media_type}.social_network_post_preview
        Example:
         * connector_social_linkedin.social_network_post_preview
