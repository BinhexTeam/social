...
class TestSocialLinkedin(LinkedinMockMixin, TestSocialCommonLinkedin):
    ...
    @patch(PATCH_ACCOUNT_LINKEDIN.format("get_entity_statistics"))
    @patch(PATCH_ACCOUNT.format("_get_default_filter_date"))
    def test_get_chart_account_statistics(
        self, mock_get_default_filter_date, mockget_entity_statistics
    ):
        ...
        mockget_entity_statistics.return_value = {
